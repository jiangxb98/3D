_base_ = [
    '_base_/datasets/ruby-fsd-far-1f.py',
...
# tools/dist_train.sh research/configs_cowa/ruby/fsd_ruby-far-1f.py 8
# tools/dist_test.sh research/configs_cowa/ruby/fsd_ruby-far-1f.py work_dirs/fsd_ruby-1f-baseline/epoch_6.pth 8 --eval cowa
