...
data = dict(
    ...
    train=dict(
        ...
        semseg_info_path='/root/3D/cowa3d/fsd/tools/data_converter/semseg_label_training_info.csv',
...
evaluation = dict(interval=24, pipeline=eval_pipeline, pc_range=point_cloud_range)
