...
@PIPELINES.register_module('DefaultFormatBundle', force=True)
...
@PIPELINES.register_module('Collect3D', force=True)
...
@PIPELINES.register_module('DefaultFormatBundle3D', force=True)
